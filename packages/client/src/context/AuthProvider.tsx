...
export interface AuthContextType {
    ...
    signup: (credentials: SignUpUserCredentials) => ServerResponse<null>;
...
export const AuthProvider = ({ children }: React.PropsWithChildren) => {
    ...
    const signup = (_credentials: SignUpUserCredentials): ServerResponse<null> => ({} as ServerResponse<null>);
